...
public class CrawlConfig {
    ...
    private static SimpleStringProperty numberOfCrawlers = new SimpleStringProperty(String.valueOf
            (DefaultConfigValues.NUMBER_OF_CRAWLERS));

    private static SimpleStringProperty maxDepthOfCrawling = new SimpleStringProperty(String.valueOf
            (DefaultConfigValues.DEPTH_OF_CRAWLING));

    private static SimpleStringProperty maxPagesToFetch = new SimpleStringProperty(String.valueOf(Integer.MAX_VALUE));

    private static SimpleStringProperty politenessDelay = new SimpleStringProperty(String.valueOf(DefaultConfigValues
            .POLITENESS_DELAY));
